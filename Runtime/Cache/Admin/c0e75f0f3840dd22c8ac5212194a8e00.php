	...
	<div class="am-g">
		<div class="am-u-sm-12 ">
			<div class="am-btn-toolbar">
				<div class="am-u-sm-5 am-btn-group am-fl" style="margin-left:-10px;">
					...
					<button type="button" id="btn_export" class=" am-btn-xs am-btn am-btn-default">
						<span class="am-icon-download"></span>
						导出当前结果
					</button>
					<span>(最多只能导出500条数据)</span>
				...
				<div class="am-u-sm-5 am-u-end">
					<form class="am-form">
						<label>预约时间:</label>
						<input type="date" value="<?php echo ($_POST['starttime']); ?>" name="starttime" id="starttime" placeholder="开始时间">~
						<input type="date" value="<?php echo ($_POST['endtime']); ?>" name="endtime" id="endtime" placeholder="结束时间">
						<button class="btn am-btn am-btn-default am-btn-sm " id="query" type="button">筛选</button>
					</form>
				</div>
			</div>
			<br>
...
<script type="text/javascript" src="/Public/static/think.js"></script>
	...
	<script type="text/javascript" src="/Public/Admin/js/suite_order_info.js"></script>
