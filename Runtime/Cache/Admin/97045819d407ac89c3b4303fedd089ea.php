		...
		<div class="am-u-sm-12 ">
			<div class="am-btn-toolbar">
				<div class="am-u-sm-9 am-btn-group am-fl" style="margin-left:-10px;">
					...
					<a href="<?php echo U('Suite/sysn');?>" id="btn_sysn" class=" am-btn-xs am-btn am-btn-default ajax-get">
...
<script type="text/javascript" src="/Public/static/think.js"></script>
	...
	<script type="text/javascript" src="/Public/Admin/js/suite.js"></script>
