...
.system-message{ padding: 48px; border:1px solid #ddd;border-radius: 10px; margin:0 auto; background:#fff; width:800px; margin-top:100px; text-align: center}
.system-message h1{ font-size: 40px; font-weight: normal; line-height: 80px; margin-bottom: 12px;color:#308B04}
