...
<!-- /头部 -->
	...
	<div class="ml_content am-g am-container am-margin-top-lg">
		...
		<div class="am-g am-g-collapse am-cf">
			<div class="lists-area am-g">
				<div class="list-fl-content am-margin-bottom">
					<ul class="brand-list am-cf am-margin-bottom-0 am-text-xs">
						<li class="bg-f5 list-left">品牌:</li>
						<li class='<?php if(($brandid) == ""): ?>am-active<?php else: endif; ?>'>
							<a href="<?php echo U('Article/index',array(pid=>$category['id'],order=>1,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>">全部</a>
						</li>
						<?php if(is_array($bdata)): $i = 0; $__LIST__ = $bdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class='<?php if(($brandid) == $vo[id]): ?>am-active<?php else: endif; ?>'>
							<a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$vo['id'],order=>1,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>" class="<?php echo ($value); ?>"><?php echo ($vo["title"]); ?></a>
					...
					<ul class="brand-list am-cf am-margin-bottom-0 am-text-xs">
						...
						<?php if(($start_price) == ""): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see));?>" class="<?php echo ($value); ?>">全部</a></li>

						<li
						<?php if(($start_price) == "0"): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>0,'end_price'=>100));?>" class="<?php echo ($value); ?>">0-100</a></li>
						<li
						<?php if(($start_price) == "100"): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>100,'end_price'=>200));?>"">100-200</a></li>
						<li
						<?php if(($start_price) == "200"): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>200,'end_price'=>300));?>"">200-300</a></li>
						<li
						<?php if(($start_price) == "300"): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>300,'end_price'=>400));?>" class="<?php echo ($value); ?>">300-400</a></li>
						<li
						<?php if(($start_price) == "400"): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>1,'sort'=>$see,start_price=>400,'end_price'=>500));?>" class="<?php echo ($value); ?>">400-500</a></li>
						<li
						<?php if(($start_price) == "500"): ?>class="active"
							<?php else: endif; ?>
						><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>$order,'sort'=>$see,start_price=>500));?>" class="<?php echo ($value); ?>">500以上</a></li>
					</ul>
				</div>
				<div class="am-g am-margin">
					...
					<?php if(($order) == "1"): ?>class="active"
						<?php else: endif; ?>
					><a rel="nofollow" href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>1,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
	   " class="<?php echo ($value); ?>">热度<i></i></a></li>
					<li
					<?php if(($order) == "2"): ?>class="active"
						<?php else: endif; ?>
					><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>2,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
	   " class="<?php echo ($value); ?>">最新<i></i></a></li>
					<li
					<?php if(($order) == "3"): ?>class="active"
						<?php else: endif; ?>
					><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>3,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
	   " class="<?php echo ($value); ?>">价格<i></i></a></li>
					<li
					<?php if(($order) == "4"): ?>class="active"
						<?php else: endif; ?>
					><a href="<?php echo U('Article/index',array(pid=>$category['id'],'brandid'=>$brandid,order=>4,'sort'=>$see,'start_price'=>$start_price,'end_price'=>$end_price));?>
				...
				<div class="am-g am-margin">
					<ul class="goodlist am-cf">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li class="face" onmouseover="this.className='facehover'" onmouseout="this.className='face'">
								<a href="<?php echo U('Article/detail?id='.$list['id']);?>" class="list-img">
									<img width="260px" height="260px" src="<?php echo (get_cover($list["cover_id"],'path')); ?>"/></a>

								<p class="am-text-center t2" style="height: 40px;"><a href="<?php echo U('Article/detail?id='.$list['id']);?>"> <?php echo ($list["title"]); ?></a></p>
