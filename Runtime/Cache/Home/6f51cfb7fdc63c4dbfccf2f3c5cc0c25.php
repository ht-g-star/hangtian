			...
			<div class="am-g am-g-fixed am-g-collapse">
				<div class="am-u-lg-12 zf_box_group">
					...
					<div class="zhfs" style="line-height: 35px;">
						<p>酒店名称：<?php echo ($data["line"]["xl_name"]); ?></p>
						<p>酒店所在地：<?php echo ($data["line"]["xl_jd_address"]); ?></p>
						<p>数量：<?php echo ($data["num"]); ?></p>
						<p>入住时间：<?php echo ($data["rzsj"]); ?></p>
						<p>入住人：<?php echo ($data["lxr"]); ?></p>
						<p>联系电话：<?php echo ($data["lxrphone"]); ?></p>
						<!--<p>出行人：<?php echo ($data["cxrname"]); ?></p>
						<p>出行人手机：<?php echo ($data["cxrphone"]); ?></p>
						<p>成人数：<?php echo ($data["crj_num"]); ?></p>-->
						
						<p>个性需求：<?php if(!empty($data["message"])): echo ($data["message"]); else: ?>无<?php endif; ?></p>
					</div>
				</div>
				<!--付款信息-->
				<div class="am-u-lg-12 am-text-right">
					<p>应付总额：<span class="sumpr blod am-text-warning "><?php echo ($money); ?></span>元</p>
		...
		<script>
			$('#ordersubmit').on('click',function(){
				if($('#isorder').val() == 1){
					...
					var data={
						num:"<?php echo I('num');?>",
						addressid:"<?php echo I('addressid');?>",
						message:"<?php echo I('message');?>",
						rzsj:"<?php echo I('rzsj');?>",
						xl_id:"<?php echo I('jdid');?>",
						price:"<?php echo I('price');?>",
						qprice:"<?php echo I('qprice');?>",
						priceid:"<?php echo I('priceid');?>"
					};
//					alert(data);
					$.ajax({
						type:"post",
						...
						success:function(e){
							if(e.status==1){
								$('#isorder').val(1);
								var url='<?php echo u("Home/Hotel/allorder");?>';
