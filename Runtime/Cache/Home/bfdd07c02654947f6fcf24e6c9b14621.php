			...
			<div class="am-u-sm-9 userCenter-r am-padding-xl">
				<div class="am-g am-margin-top-lg">
					<div class="am-u-sm-6 am-cf">
						...
						<p class="am-fl am-padding am-text-lg">
							<?php echo ($user["realname"]); ?><br>
							<a href="<?php echo U('Member/index');?>" class="am-text-warning am-text-xs">个人信息 ></a><br>

							<?php if(C('SIGN_SCORE') > 0): if(isSigned(is_login())): ?><button class="am-btn am-btn-xs am-btn-warning am-disabled" type="button">已签到
									</button>
									<?php else: ?>
					...
					<div class="am-u-sm-6">
						<p class="am-padding-xl am-text-right am-text-sm">
							会员等级：<span class="am-text-warning"><?php echo (get_rank($user["rank"])); ?></span><br>
							手机号：<?php echo ($user["mobile"]); ?><br>
							会员积分：<span id="score" class="am-text-warning"><?php echo (get_score($user["id"])); ?></span><br>
							
								<!-- 此处是关爱通 -->
						<?php if(($in_list) == "1"): ?>关爱积分：<span class="am-text-warning"><?php echo ($gatjf_balance); ?>&nbsp;<a class="am-text-primary am-text-sm" href="<?php echo U('Change/change');?>">兑换</a> </span><br><?php endif; ?>
							
							可用余额：<span class="am-text-warning"><?php echo (round($user["balance"],2)); ?> <a class="am-text-primary am-text-sm" href="<?php echo U('Pay/chongzhi');?>">去充值</a> </span>
						</p>
					</div>
				</div>
				<hr>
				<div class="am-g">
					<div class="am-u-sm-6 am-cf am-padding-xl">
						<img src="/Public/static/amaze/i/icon-userCenter01.png" class="am-fl">

						<p class="am-fl am-padding  ">
							待支付的订单：<a href="<?php echo U('Home/Center/needpay');?>" class="am-text-warning"><?php echo ((isset($onum) && ($onum !== ""))?($onum):0); ?></a>
							<br>
							<a href="<?php echo U('Home/Center/needpay');?>" class="am-link-muted am-text-sm">查看 ></a>
						</p>

						<div class="am-cf am-margin-xl"></div>
						<img src="/Public/static/amaze/i/icon-userCenter02.png" class="am-fl">

						<p class="am-fl am-padding  am-padding-top-xs">
							待确认商品数：<a href="<?php echo U('Home/Center/tobeconfirmed');?>" class="am-text-warning"><?php echo ($cnum); ?></a>
							<br>
							<a href="<?php echo U('Home/Center/tobeconfirmed');?>" class="am-link-muted am-text-sm">查看 ></a>
						</p>
					</div>
					<div class="am-u-sm-6 am-cf am-padding-xl">
						<img src="/Public/static/amaze/i/icon-userCenter03.png" class="am-fl">

						<p class="am-fl am-padding  am-padding-top-xs">
							待收货的订单：<a href="<?php echo U('Home/Center/tobeshipped');?>" class="am-text-warning"><?php echo ($dnum); ?></a>
							<br>
							<a href="<?php echo U('Home/Center/tobeshipped');?>" class="am-link-muted am-text-sm">查看 ></a>
						</p>

						<div class="am-cf am-margin-xl"></div>
						<img src="/Public/static/amaze/i/icon-userCenter04.png" class="am-fl">

						<p class="am-fl am-padding  am-padding-top-xs">
							收藏的商品：<a href="<?php echo U('Home/Collect/index');?>" class="am-text-warning"><?php echo ($ccnum); ?></a>
							<br>
							<a href="<?php echo U('Home/Collect/index');?>" class="am-link-muted am-text-sm">查看 ></a>
						</p>
					</div>
				</div>
			</div>
