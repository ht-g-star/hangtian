...
$("a[href='" + url + "']").addClass("am-active");
                ...
                <div class="am-g" id="MemberCenterCtrl">
                    ...
                    <div class="am-tabs am-margin-left">
                        <ul class="am-tabs-nav am-nav am-nav-tabs">
                            <li><a href='<?php echo U("Center/allorder");?>' class="red">所有订单</a></li>
                            <li class="am-active"><a href='<?php echo U("Center/needpay");?>' class="red">待支付订单</a></li>
			...
			<?php if(($po['status']) > "2"): ?><b><a href="<?php echo U('order/del?tag='.$po['tag']);?>"><img src="/Public/Home/images/iconfont-lajixiang.png" width="20"
			    ...
			    <span class="am-padding-left-sm"><A href="<?php echo U('Article/detail?id='.$vo['goodid']);?>">
                    <img src="<?php echo (get_cover(get_cover_id($vo["goodid"]),'path')); ?>" width="70" height="70"/></a>
					  <span style="width:170px;" class="am-inline-block am-text-sm"><a
                              href="<?php echo U('Article/detail?id='.$vo['goodid']);?>"> <?php echo (get_good_name($vo["goodid"])); ?></a></span>
				...
				<span class="c2">  <?php if($vo['status']==1||$vo['status']==2){echo "无" ;}; if($vo['status']==3){echo "<a href='index.php?s=/Home/back/index/id/".$vo[' id']."'>退货</a>
                    ...
                    &nbsp;";}; if($vo['iscomment']==1){echo "<br/><a href='index.php?s=/Home/comment/index/id/".$vo[' id']."'>评价商品</a>";}; if($vo['iscomment']==2){echo "<br/><a href='index.php?s=/Home/comment/index/id/".$vo[' id']."'>已评价</a>";}; ?></span>
                                            ...
                                            <div class="total-area">
                                                ...
                                                <p class="am-padding-0 am-margin-0 am-text-xs">(运费￥<?php echo ($po["ship_price"]); ?>)</p>
                                            </div>
                                            <div class="deal-area">
                                                <p class="red am-text-sm">
                                                    <?php $status=$po['status'];if($status==13){ echo "待支付";}; if($status==1){ echo "待发货";}; if($status==2){ echo "已发货";}; if($status==3){ echo "交易成功";}; if($status==4){ echo "申请取消订单";}; if($status==5){ echo "取消订单被拒绝";}; if($status==6){ echo "订单已取消";}; ?>
                                                </p>
