				...
				<div class="am-g" id="MemberCenterCtrl">
					...
					<div class="am-tabs am-margin-left">
						<ul class="am-tabs-nav am-nav am-nav-tabs">
							<li class="am-active"><a href='<?php echo U("Hotel/allorder");?>' class="red">所有订单</a></li>
							<li><a href='<?php echo U("Hotel/needpay");?>' class="red">待支付订单</a></li>
					...
					<!--<div id="shaiorder">
						<span>筛选：</span>
						<a href='<?php echo U("Center/allorder");?>' <?php if(empty($ordertype)): ?>class='selected'<?php endif; ?>>全部订单</a>
						<a href='<?php echo U("Center/allorder",array("ordertype"=>1));?>' <?php if(($ordertype) == "1"): ?>class='selected'<?php endif; ?>>普通订单</a>
						<a href='<?php echo U("Center/allorder",array("ordertype"=>2));?>' <?php if(($ordertype) == "2"): ?>class='selected'<?php endif; ?>>酒店订单</a>
						<a href='<?php echo U("Center/allorder",array("ordertype"=>3));?>' <?php if(($ordertype) == "3"): ?>class='selected'<?php endif; ?>>线路订单</a>
					</div>-->
		    ...
		    <span class="c2 am-padding-top-sm am-padding-right-xs am-text-xs" style="white-space: nowrap">
			    ...
			    &nbsp;";}; if($vo['status']==-8){echo "<a href='index.php?s=/Home/Exchange/detail/id/".$vo['id']."'>换货完成</a>&nbsp;";}; if($vo['iscomment']==1){echo "<br/><a href='index.php?s=/Home/comment/index/id/".$vo['id']."'>评价</a>";}; if($vo['iscomment']==2){echo "<br/><a href='index.php?s=/Home/comment/lists'>已评价</a>";}; ?></span>
										...
										<div class="total-area">
											...
											<?php if(($po["ordertype"]) == "1"): ?><p class="am-text-xs">(运费￥<?php echo ($po["ship_price"]); ?>)</p><?php endif; ?>
										</div>
										<div class="deal-area">
