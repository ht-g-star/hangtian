    ...
    <div class="am-g am-container">
        <div class="am-g">
            <div class=" am-u-sm-12">
                <hr>
                <p class="am-text-lg am-padding-0 am-margin-0">套餐: <span class="am-text-warning"><?php echo ($data["title"]); ?></span>
                </p>
            </div>
        </div>
        <hr>
        <div class="am-g am-padding am-margin">
            <div class="bg-f5 am-padding-xl">
                ...
                <p>时间:<span class="am-text-warning"><?php echo ($period["period"]); ?> <?php echo ($time); ?></span>,还剩余: <span class="am-text-warning"><?php echo ($period['total_num']-$period['use_num']); ?></span>
                </p>
                <div class="am-g am-padding-sm bg-fff">
                    <table class="am-table">
                        ...
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$i): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($period["period"]); ?>|<?php echo ($time); ?></td>
                                <td><?php echo ($i["id_num"]); ?></td>
                                <td><?php echo ($i["realname"]); ?></td>
                                <td><?php echo (get_sex($i["sex"])); ?></td>
                ...
                <div class="am-g bg-fff">
                    ...
                    <div class="am-u-sm-12 am-margin-0">
                        <?php $order = $_SESSION['onethink_home']['order']; ?>
                        <p class="am-text-right"> 订单总额: <span class="am-text-warning num-text am-text-xl">¥ <?php echo ($order["cost"]); ?></span></p>
                    </div>
                </div>
                <div class="am-g bg-fff">
                    <hr>
...
<div class="hidden am-hide"><!-- 用于加载统计代码等隐藏元素 -->
    ...
    <script>
        $("#order_confirm").click(function () {
            $.get("<?php echo U('Home/Suite/order_confirm');?>", function (data) {
                if (data) {
