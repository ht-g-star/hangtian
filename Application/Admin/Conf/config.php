...
//		    'DEFAULT_THEME' =>  'default',  // 默认模板主题名称
	...
	/* 后台错误页面模板 */
	'TMPL_ACTION_ERROR'     => MODULE_PATH . 'View/amaze/Public/error.html', // 默认错误跳转对应的模板文件
	'TMPL_ACTION_SUCCESS'   => MODULE_PATH . 'View/amaze/Public/success.html', // 默认成功跳转对应的模板文件
	'TMPL_EXCEPTION_FILE'   => MODULE_PATH . 'View/amaze/Public/exception.html',// 异常页面的模板文件


	/*会员Excel上传配置*/
	'MEMBER_UPLOAD'         => array (
		"exts"     => array ('xls', 'xlsx'),
		"savePath" => "member_import/",
