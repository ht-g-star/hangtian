...
class StatisticsController extends AdminController {
	...
	public function index() {
		...
		$this->assign('a', $percent_a ? $percent_a : null);
		$this->assign('b', $percent_b ? $percent_b : null);
		$this->assign('c', $percent_c ? $percent_c : null);
		$this->assign('d', $percent_d ? $percent_d : null);
		/*利润*/
