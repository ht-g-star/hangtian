...
class SuiteOrderController extends FollowerController {
	/* 预约管理首页*/
	...
	public function allorder() {
		...
		$list = $db->alias("o")->field("s.id as s_id,s.price_sex_0,s.price_sex_1,s.title,o.id,o.order_no,o.ctime,o.count,o.cost,o.status")->limit($page->firstRow . ',' . $page->listRows)->where($map)->join($join)->order("o.id desc")->select();
		if (empty($list)) {
			$list = array ();
		}
